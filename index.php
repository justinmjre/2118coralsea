				...
				<!-- Intro -->
					<section id="top" class="one">
						<div class="container">
							...
							<header>
								<h3 class="alt">Thinking about selling <span class="blackblock"> 2118 Coral Sea Street?</span> Let us help! Team Fast Agents is YOUR personal team of professionals who makes Real Estate <span class="blueblock">EASY</span> for <span class="greenblock">YOU.</span></h3>
							</header>
					...
					<section id="about" class="three">
						<div class="container">
							<header>
								...
								<h3 style="color: #ecf0f1;">Properties sold within area of 2118 Coral Sea Street</h3>
							</header>
							<div class="row">
								<div class="4u">
									<article class="item">
										...
										<header>
										<h3><strong>259 Ansel Ave</strong></h3>
										<ul>
											<li>4 Bed - 3 Bath</li>
											<li>2,361 Sq Ft -  3,010 Lot</li>
											<li>List: 11/1/13 - Sold: 11/14/13</li>
											<li>List: $798,000 - SOLD $820,000</li>
										</ul>
									</article>
								</div>
								<div class="4u">
									<article class="item">
										...
										<header>
										<h3><strong>2351 Glenview St</strong></h3>
										<ul>
											<li>4 Bed - 2.5 Bath</li>
											<li>2,361 Sq Ft - 3,583 Lot</li>
											<li>List: 7/30/13 - Sold: 11/1/13</li>
											<li>List: $825,000 - SOLD $825,000</li>
										</ul>
									</article>
								</div>
								<div class="4u">
									<article class="item">
										...
										<header>
										<h3><strong>239 Hollister Ave</strong></h3>
										<ul>
											<li>4 Bed - 3 Bath</li>
											<li>2,539 Sq Ft - 3,760 Lot</li>
											<li>List: 12/12/13 - Sold: 1/3/14</li>
											<li>List: $930,000 - SOLD: Pending</li>
										</ul>
									</article>
								</div>
							</div>
